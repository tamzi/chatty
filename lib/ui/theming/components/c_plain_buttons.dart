...
class CPlainFlatButton extends StatelessWidget {
  final String label;
  final VoidCallback? onPressed;

  const CPlainFlatButton({
    Key? key,
    required this.label,
    this.onPressed,
  }) : super(key: key);
...
class CWarningFlatButton extends StatelessWidget {
  final String label;
  final VoidCallback? onPressed;

  const CWarningFlatButton({
    Key? key,
    required this.label,
    this.onPressed,
  }) : super(key: key);
...
class _ButtonBuilder {
  ...
  Widget build(BuildContext context) {
    return RawMaterialButton(
        onPressed: onPressed,
        textStyle: CTheme.of(context).buttonText,
